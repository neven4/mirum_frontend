...
const Like = ({ active, click, numOfLikes, className }) => {
  return (
    <section className={ `${ styles.like } ${ className }` }>
      <div className={ styles.like_icon }
        onClick={ click }
      >
        <svg width="100%" height="100%" viewBox="0 0 21 21" fill={ active ? '#FF2929' : 'none' } xmlns="http://www.w3.org/2000/svg">

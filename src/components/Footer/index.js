					...
					<li>
						<Link to='/cafes'>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill={pathname.indexOf("/cafes") === 0 ? "#2A2A2A" : "#BABABA"}
									fillRule="evenodd"
									clipRule="evenodd"
					...
					<li>
						<Link to='/'>
							<svg width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									fill={pathname === "/" || pathname.indexOf("/map") === 0 ? "#2A2A2A" : "#BABABA"}
									stroke={pathname === "/" || pathname.indexOf("/map") === 0 ? "#2A2A2A" : "#BABABA"}
									d="M1 12.3333L26 1L13.8378 25L12.4865 14.3333L1 12.3333Z"
									strokeLinecap="round"
